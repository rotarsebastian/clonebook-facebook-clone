...
const geolocate = async(city) => {
    const mapAccKey = process.env.MAP_KEY || mapKey;
    const url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(city)}.json?access_token=${mapAccKey}&limit=1&lang=en`;
