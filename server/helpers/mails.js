...
const constructActivationEmail = user => {
    ...
    newEmail.html = `<h1 style="color:#ff9800;">Welcome, ${first_name}!</h1>
                    <h4 style="margin-top: 20px;color:#485877;font-size:14px;margin-bottom:0;"=>One last step to fully activate your account. Click the link below and your Clonebook account is ready!</h4><br>
